...
const experience = {
  ...
  title: "My experience",
  description:
    "Over 2 years of hands-on experience in web & mobile development, network systems engineering, and digital marketing, driving impactful solutions and measurable results.",
  items: [
    {
...
const skills = {
  title: "My skills",
  description:
    "Versatile expertise in web & mobile development, network systems engineering, and digital marketing strategies.",
  skilllist: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
