          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              ...
              <p className="text-white/60">
                Let&apos;s work together to bring your ideas to life. Whether
                you&apos;re looking to build a powerful website, optimize your
                digital strategy, or implement innovative solutions, I&apos;m
                here to collaborate and help you achieve your goals. Let&apos;s
              ...
              />
              <Button size="md" className="max-w-45 hover:text-white/80">
                Send message &#10230;
              </Button>
            </form>
          </div>
